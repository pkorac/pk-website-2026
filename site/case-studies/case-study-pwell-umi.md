...
Umi isn't a solo coach. One of the unique features is its multiplayer first approach to interacting with AI. It's not about an individual, it's about the family as a whole.
...
5. **Service blueprint and integration exploration (parallel track)**  
   In parallel, we developed a visual design direction, a service map/blueprint of the wider experience, and partner integration concepts – including how they would plug into the end-to-end journey.
...
- Aligned a cross-disciplinary client team around a shared vision and a concrete set of partner integration concepts
