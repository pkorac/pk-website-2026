...
- **A capture pipeline** that ingested posts from a Slack channel and pulled out the useful bits (links, text, attachments, conversation threads)
- **A ranking approach** that used engagement signals (reactions, replies) to prioritise what mattered
- **A simple curation layer** to group items into digestible sections (themes/categories)
- **A weekly newsletter output** that could be posted back into Slack (and/or sent by email) as a “best of the week” summary
